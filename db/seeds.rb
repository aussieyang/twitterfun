...
users = User.create([{name: 'Brad', email: 'brad@example.com', password_digest: @password, imgurl: 'https://media.licdn.com/media/AAEAAQAAAAAAAATyAAAAJDY5NzA4MjhiLWIwMjktNDIzMy05NmVjLWIwZjQ5OTA3MTZlOQ.jpg'},
  ...
  {name: 'Peter', email: 'peter@example.com', password_digest: @password, imgurl: 'https://media.licdn.com/mpr/mpr/shrinknp_400_400/p/6/000/22c/1f8/1b04b9f.jpg'},
  ...
  {name: 'Mark', email: 'mark@example.com', password_digest: @password, imgurl: 'http://www.mixtapetorrent.com/system/files/goldenchild7.jpg'}
  ])
